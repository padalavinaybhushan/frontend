...
<img src="`+picture+`" alt="image" width="220" height="220">
              <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0">
                <div class="primary-info">
                              <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">`+name+`</h1>
                  <div class="title mb-3">`+profession+`</div>
                  <ul class="list-unstyled">
                    <li class="mb-2"><a href="mailto:zveryanovstanis@gmail.com"><i class="far fa-envelope fa-fw mr-2" data-fa-transform="grow-3"></i>`+email+`</a></li>
                    <li><a><i class="fas fa-mobile-alt fa-fw mr-2" data-fa-transform="grow-6"></i>`+phone+`</a></li>
                  </ul>
                </div>
                <div class="secondary-info ml-md-auto mt-2">
                              <ul class="resume-social list-unstyled">
                          <li class="mb-3"><a href="https://t-do.ru/shcok7"><span class="fa-container text-center mr-2"><i class="fab fa-twitter fa-fw"></i></span>`+twitter+`</a></li>
                          <li class="mb-3"><a href="https://behance.net/twstrblg"><span class="fa-container text-center mr-2"><i class="fab fa-github fa-fw"></i></span>`+github+`</a></li>
                          <li><a href="https://psnprofiles.com/twisterblog"><span class="fa-container text-center mr-2"><i class="fab fa-linkedin"></i></span>`+linkedin+`</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="resume-body p-5">
            <section class="resume-section summary-section mb-5">
              <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Description</h2>
              <div class="resume-section-content">
                <p class="mb-0">`+resumecontent+`</p>
              </div>
            </section>
            <div class="row">
              <div class="col-lg-7">
                  ...
                  <div class="resume-section-content">
                    <div class="resume-timeline position-relative">
                      <article class="resume-timeline-item position-relative pb-5">
                        ...
                        <div class="resume-timeline-item-header mb-2">
                          <div class="d-flex flex-column flex-md-row">
                              <h3 class="resume-position-title font-weight-bold mb-1">`+experience1+`</h3>
                      ...
                      <article class="resume-timeline-item position-relative pb-5">
                        ...
                        <div class="resume-timeline-item-header mb-2">
                          <div class="d-flex flex-column flex-md-row">
                              <h3 class="resume-position-title font-weight-bold mb-1">`+experience2+`</h3>
                      ...
                      <article class="resume-timeline-item position-relative pb-5">
                        ...
                        <div class="resume-timeline-item-header mb-2">
                          <div class="d-flex flex-column flex-md-row">
                              <h3 class="resume-position-title font-weight-bold mb-1">`+experience3+`</h3>
              ...
              <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3">Location</h2>
              <div class="resume-section-content">
                <ul class="list-unstyled resume-awards-list">
                  <li class="mb-2 pl-4 position-relative">
                      <i class="resume-award-icon fas fa-location-arrow position-absolute" data-fa-transform="shrink-2"></i>
                      <div class="resume-award-name">Current Location</div>
                  </li>
                  <li class="mb-2">
                    <ul>
                      <li><div >`+currentLocation+`</div></li>
                    </ul>
                  </li>

                  <li class="mb-2 pl-4 position-relative">
                      <i class="resume-award-icon fas fa-location-arrow position-absolute" data-fa-transform="shrink-2"></i>
                      <div class="resume-award-name"> Address</div>
                  </li>
                  <li class="mb-2">
                    <ul>
                      <li><div >`+address+`</div></li>
                    </ul>
                  </li>
                  ...
                  <div class="resume-section-content">
                      <div class="resume-skill-item">
                        ...
                        <ul class="list-unstyled mb-4">
                          <li class="mb-2">
                              <div class="resume-skill-name">`+skill1+`</div>
                           
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+skill2+`</div>
                            
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+skill3+`</div>
                            
                          </li>
                          
                          <li class="mb-2">
                              <div class="resume-skill-name">`+skill4+`</div>
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+skill5+`</div>
                      ...
                      <div class="resume-skill-item">
                          <h4 class="resume-skills-cat font-weight-bold">Hobbies</h4>
                        <ul class="list-unstyled">
                          <li class="mb-2">
                              <div class="resume-skill-name">`+ho1+`</div>
                           
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+ho2+`</div>
                           
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+ho3+`</div>
                           
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+ho4+`</div>
                           
                          </li>
                          <li class="mb-2">
                              <div class="resume-skill-name">`+ho5+`</div>
                ...
                <section class="resume-section education-section mb-5">
                  ...
                  <div class="resume-section-content">
                    <ul class="list-unstyled">
                      <li class="mb-2">
                          <div class="resume-degree font-weight-bold">Graduation</div>
                          <div class="resume-degree-org">`+graduation+`</div>
                        
                      </li>
                      <li>
                          <div class="resume-degree font-weight-bold">School</div>
                          <div class="resume-degree-org">`+school+`</div>
  ...
  // Create a Blob object to store the resume document
  const blob = new Blob([resume1], { type: "text/html" });
